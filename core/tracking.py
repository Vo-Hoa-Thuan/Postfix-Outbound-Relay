...
def get_message_history(msg_id_snippet: str, limit: int = 50) -> List[Dict[str, str]]:
    ...
    try:
        ...
        res = subprocess.run(find_qid_cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True, timeout=5)
        ...
        res = subprocess.run(trace_cmd, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True, timeout=10)
...
def get_queue_status() -> Dict[str, Any]:
    ...
    try:
        ...
        res = subprocess.run("mailq | tail -n 1", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)
